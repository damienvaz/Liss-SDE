			...
			match(T__26);
			        ...
			        if((((HeadContext)_localctx).e.typeS != null) && ((HeadContext)_localctx).e.typeS.equals("sequence")){
			            ...
			            if(((HeadContext)_localctx).e.mipsCodeS!=null){
			                if(isThereAStateToBeSavedPreviously==false && _localctx.mipsCodeS == null){
